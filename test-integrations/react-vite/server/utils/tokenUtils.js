...
import { getConfig, getExecuteOptions } from '../authConfig.js';
...
export async function refreshTokens(session) {
    try {
        ...
        // Perform token refresh with HTTP support for development
        const execOpts = getExecuteOptions();
        const refreshOptions = execOpts ? { execute: execOpts } : undefined;
