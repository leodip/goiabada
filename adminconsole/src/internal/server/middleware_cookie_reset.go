...
// MiddlewareCookieReset handles invalid session cookies by clearing them and redirecting.
// It improves user experience by automatically recovering from session decoding errors.
