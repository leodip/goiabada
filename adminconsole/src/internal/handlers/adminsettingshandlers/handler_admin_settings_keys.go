...
import (
	...
	"github.com/leodip/goiabada/adminconsole/internal/rsautil"
...
func HandleAdminSettingsKeysRotatePost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditRotatedKeys, map[string]interface{}{
...
func HandleAdminSettingsKeysRevokePost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditRevokedKey, map[string]interface{}{
			"loggedInUser": authHelper.GetLoggedInSubject(r),
