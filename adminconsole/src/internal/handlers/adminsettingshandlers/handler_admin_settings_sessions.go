...
func HandleAdminSettingsSessionsPost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditUpdatedSessionsSettings, map[string]interface{}{
		...
		http.Redirect(w, r, fmt.Sprintf("%v/admin/settings/sessions", config.AdminConsoleBaseUrl), http.StatusFound)
	}
}
