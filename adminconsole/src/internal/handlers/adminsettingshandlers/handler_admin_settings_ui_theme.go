...
func HandleAdminSettingsUIThemePost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditUpdatedUIThemeSettings, map[string]interface{}{
		...
		http.Redirect(w, r, fmt.Sprintf("%v/admin/settings/ui-theme", config.AdminConsoleBaseUrl), http.StatusFound)
	}
}
