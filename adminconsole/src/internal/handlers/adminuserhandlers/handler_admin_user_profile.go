...
import (
	...
	"github.com/leodip/goiabada/adminconsole/internal/locales"
...
func HandleAdminUserProfilePost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditUpdatedUserProfile, map[string]interface{}{
			"userId":       user.Id,
			"loggedInUser": authHelper.GetLoggedInSubject(r),
		})

		http.Redirect(w, r, fmt.Sprintf("%v/admin/users/%v/profile?page=%v&query=%v", config.AdminConsoleBaseUrl, user.Id,
