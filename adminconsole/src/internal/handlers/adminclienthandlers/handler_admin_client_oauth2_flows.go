...
func HandleAdminClientOAuth2Post(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditUpdatedClientOAuth2Flows, map[string]interface{}{
			"clientId":     client.Id,
			"loggedInUser": authHelper.GetLoggedInSubject(r),
		})

		http.Redirect(w, r, fmt.Sprintf("%v/admin/clients/%v/oauth2-flows", config.AdminConsoleBaseUrl, client.Id), http.StatusFound)
	}
}
