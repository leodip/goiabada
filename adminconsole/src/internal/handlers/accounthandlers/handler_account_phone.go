...
import (
	...
	"github.com/leodip/goiabada/adminconsole/internal/customerrors"
	...
	"github.com/leodip/goiabada/adminconsole/internal/phonecountries"
...
func HandleAccountPhoneVerifyPost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditVerifiedPhone, map[string]interface{}{
			"userId":       user.Id,
			"loggedInUser": authHelper.GetLoggedInSubject(r),
		})

		http.Redirect(w, r, config.AdminConsoleBaseUrl+"/account/phone", http.StatusFound)
	}
}
...
func HandleAccountPhoneSendVerificationPost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditSentPhoneVerificationMessage, map[string]interface{}{
			"userId":       user.Id,
			"loggedInUser": authHelper.GetLoggedInSubject(r),
		})
...
func HandleAccountPhonePost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditUpdatedUserPhone, map[string]interface{}{
			"userId":       user.Id,
			"loggedInUser": authHelper.GetLoggedInSubject(r),
		})
