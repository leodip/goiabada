...
func HandleAccountEmailSendVerificationPost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		bind := map[string]interface{}{
			...
			"link": config.AdminConsoleBaseUrl + "/account/email-verify?code=" + verificationCode,
		}
...
func HandleAccountEmailVerifyGet(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		audit.Log(constants.AuditVerifiedEmail, map[string]interface{}{
			"userId":       user.Id,
			"loggedInUser": authHelper.GetLoggedInSubject(r),
		})

		http.Redirect(w, r, config.AdminConsoleBaseUrl+"/account/email", http.StatusFound)
	}
}
...
func HandleAccountEmailPost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if input.Email != user.Email {
			...
			audit.Log(constants.AuditUpdatedUserEmail, map[string]interface{}{
				"userId":       user.Id,
				"loggedInUser": authHelper.GetLoggedInSubject(r),
			})
		}
