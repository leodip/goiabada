...
A browser-based JavaScript [test client](https://github.com/leodip/goiabada/tree/main/test-integrations/js-only) using the [oauth4webapi](https://github.com/panva/oauth4webapi) library.

### Go web application

A sample integration using Go. See the [go-webapp example](https://github.com/leodip/goiabada/tree/main/test-integrations/go-webapp).
