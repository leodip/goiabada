...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Yes</td>
      <td>A random string between 43 and 128 characters long used for PKCE.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>No</td>
      <td>Supported values: <code>query</code> (default), <code>fragment</code> or <code>form_post</code>.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Recommended</td>
      <td>Any string. Goiabada will echo back the nonce value in the ID token, as a claim, for replay protection.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The original string from which the <code>code_challenge</code> was derived. Required for PKCE.</td>
    </tr>
    <tr>
      <td style="white-space: nowrap;"><code>scope</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>name</code>, <code>given_name</code>, <code>middle_name</code>, <code>family_name</code>, <code>nickname</code>, <code>preferred_username</code>, <code>profile</code>, <code>website</code>, <code>gender</code>, <code>birthdate</code>, <code>zoneinfo</code>, <code>locale</code>, <code>updated_at</code></td>
    </tr>
    <tr>
