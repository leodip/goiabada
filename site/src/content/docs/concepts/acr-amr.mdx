...
<Aside type="tip">
If you request multiple ACR values separated by spaces, Goiabada uses the first one in the list, and
then raises it to the client's default ACR level if it is below it.
</Aside>
