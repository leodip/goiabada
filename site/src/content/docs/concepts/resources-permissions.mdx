...
**Format:** `resource-identifier:permission-identifier`, both halves case-sensitive
...
A permission identifier only has meaning within the resource it belongs to. Two resources can each
