...
Refresh tokens are used in the authorization code flow with PKCE and in the resource owner password credentials flow (the client credentials flow doesn't use refresh tokens).
