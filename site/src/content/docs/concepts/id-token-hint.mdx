...
- If the user has a session for a different user → re-authentication required, and once the hinted user signs in, the session that was in the browser is ended and replaced (see [User sessions](/concepts/user-sessions/))
