...
<CardGrid stagger>
  ...
  <Card title="Two-factor authentication" icon="approve-check-circle">
    Extra security with one-time passwords (OTP). Protect user accounts with industry-standard 2FA.
  </Card>
