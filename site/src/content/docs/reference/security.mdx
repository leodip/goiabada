...
- **Opaque identifier** - Cookie names the session; contents stay on the server
- **Admin console cookie** - Dropped when the browser closes; session restore may return it
