...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>false</code></td>
      <td>Log HTTP requests, one record per request on the application log (stderr). Query parameter values are redacted apart from a short assessed-safe list. See <a href="/reference/security/">Security</a>.</td>
    </tr>
    <tr>
