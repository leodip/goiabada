...
| Platform | Auth server | Admin console |
|----------|-------------|---------------|
| Linux (x64) | `goiabada-authserver-linux-amd64` | `goiabada-adminconsole-linux-amd64` |
| Linux (ARM) | `goiabada-authserver-linux-arm64` | `goiabada-adminconsole-linux-arm64` |
| macOS (Intel) | `goiabada-authserver-darwin-amd64` | `goiabada-adminconsole-darwin-amd64` |
| macOS (Apple Silicon) | `goiabada-authserver-darwin-arm64` | `goiabada-adminconsole-darwin-arm64` |
| Windows | `goiabada-authserver-windows-amd64.exe` | `goiabada-adminconsole-windows-amd64.exe` |

```bash
# Example for Linux amd64 - download from the releases page
# https://github.com/leodip/goiabada/releases
chmod +x goiabada-authserver-linux-amd64 goiabada-adminconsole-linux-amd64
```
