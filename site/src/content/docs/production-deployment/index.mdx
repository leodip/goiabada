...
<Aside type="tip">
Before going live, review the [production checklist](/production-deployment/production-checklist/) for security and configuration requirements. When it's time to move to a new version, see [Upgrading](/production-deployment/upgrading/).
</Aside>
