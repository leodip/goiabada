...
func (d *CommonDatabase) CreateClient(tx *sql.Tx, client *entities.Client) error {
	...
	clientStruct := sqlbuilder.NewStruct(new(entities.Client)).
		For(d.Flavor)
...
func (d *CommonDatabase) UpdateClient(tx *sql.Tx, client *entities.Client) error {
...
func (d *CommonDatabase) getClientCommon(tx *sql.Tx, selectBuilder *sqlbuilder.SelectBuilder,
	clientStruct *sqlbuilder.Struct) (*entities.Client, error) {
...
func (d *CommonDatabase) GetClientById(tx *sql.Tx, clientId int64) (*entities.Client, error) {
...
func (d *CommonDatabase) GetClientByClientIdentifier(tx *sql.Tx, clientIdentifier string) (*entities.Client, error) {
...
func (d *CommonDatabase) ClientLoadRedirectURIs(tx *sql.Tx, client *entities.Client) error {
...
func (d *CommonDatabase) ClientLoadWebOrigins(tx *sql.Tx, client *entities.Client) error {
...
func (d *CommonDatabase) GetClientsByIds(tx *sql.Tx, clientIds []int64) ([]entities.Client, error) {
...
func (d *CommonDatabase) ClientLoadPermissions(tx *sql.Tx, client *entities.Client) error {
...
func (d *CommonDatabase) GetAllClients(tx *sql.Tx) ([]*entities.Client, error) {
