...
func (d *CommonDatabase) CreatePreRegistration(tx *sql.Tx, preRegistration *entitiesv2.PreRegistration) error {
...
func (d *CommonDatabase) GetPreRegistrationById(tx *sql.Tx, preRegistrationId int64) (*entitiesv2.PreRegistration, error) {
...
func (d *CommonDatabase) GetPreRegistrationByEmail(tx *sql.Tx, email string) (*entitiesv2.PreRegistration, error) {
