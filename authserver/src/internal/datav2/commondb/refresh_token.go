...
func (d *CommonDatabase) CreateRefreshToken(tx *sql.Tx, refreshToken *entitiesv2.RefreshToken) error {
...
func (d *CommonDatabase) GetRefreshTokenById(tx *sql.Tx, refreshTokenId int64) (*entitiesv2.RefreshToken, error) {
...
func (d *CommonDatabase) RefreshTokenLoadCode(tx *sql.Tx, refreshToken *entitiesv2.RefreshToken) error {
	if refreshToken == nil {
		return nil
	}
...
func (d *CommonDatabase) GetRefreshTokenByJti(tx *sql.Tx, jti string) (*entitiesv2.RefreshToken, error) {
