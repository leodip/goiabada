...
func (d *CommonDatabase) GetWebOriginById(tx *sql.Tx, webOriginId int64) (*entitiesv2.WebOrigin, error) {
...
func (d *CommonDatabase) GetWebOriginsByClientId(tx *sql.Tx, clientId int64) ([]entitiesv2.WebOrigin, error) {
...
func (d *CommonDatabase) GetAllWebOrigins(tx *sql.Tx) ([]*entitiesv2.WebOrigin, error) {
