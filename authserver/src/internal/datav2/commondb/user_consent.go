...
func (d *CommonDatabase) GetUserConsentById(tx *sql.Tx, userConsentId int64) (*entitiesv2.UserConsent, error) {
...
func (d *CommonDatabase) GetConsentByUserIdAndClientId(tx *sql.Tx, userId int64, clientId int64) (*entitiesv2.UserConsent, error) {
...
func (d *CommonDatabase) UserConsentsLoadClients(tx *sql.Tx, userConsents []entitiesv2.UserConsent) error {
...
func (d *CommonDatabase) GetConsentsByUserId(tx *sql.Tx, userId int64) ([]entitiesv2.UserConsent, error) {
