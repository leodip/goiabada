...
func (d *CommonDatabase) GetPermissionById(tx *sql.Tx, permissionId int64) (*entitiesv2.Permission, error) {
...
func (d *CommonDatabase) GetPermissionByPermissionIdentifier(tx *sql.Tx, permissionIdentifier string) (*entitiesv2.Permission, error) {
...
func (d *CommonDatabase) GetPermissionsByResourceId(tx *sql.Tx, resourceId int64) ([]entitiesv2.Permission, error) {
...
func (d *CommonDatabase) PermissionsLoadResources(tx *sql.Tx, permissions []entitiesv2.Permission) error {
...
func (d *CommonDatabase) GetPermissionsByIds(tx *sql.Tx, permissionIds []int64) ([]entitiesv2.Permission, error) {
