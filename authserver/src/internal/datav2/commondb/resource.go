...
func (d *CommonDatabase) CreateResource(tx *sql.Tx, resource *entitiesv2.Resource) error {
...
func (d *CommonDatabase) GetResourceById(tx *sql.Tx, resourceId int64) (*entitiesv2.Resource, error) {
...
func (d *CommonDatabase) GetResourceByResourceIdentifier(tx *sql.Tx, resourceIdentifier string) (*entitiesv2.Resource, error) {
...
func (d *CommonDatabase) GetResourcesByIds(tx *sql.Tx, resourceIds []int64) ([]entitiesv2.Resource, error) {
...
func (d *CommonDatabase) GetAllResources(tx *sql.Tx) ([]entitiesv2.Resource, error) {
	resourceStruct := sqlbuilder.NewStruct(new(entitiesv2.Resource)).
		For(d.Flavor)
