...
func (d *CommonDatabase) CreateKeyPair(tx *sql.Tx, keyPair *entitiesv2.KeyPair) error {
...
func (d *CommonDatabase) GetKeyPairById(tx *sql.Tx, keyPairId int64) (*entitiesv2.KeyPair, error) {
...
func (d *CommonDatabase) GetAllSigningKeys(tx *sql.Tx) ([]entitiesv2.KeyPair, error) {
	keyPairStruct := sqlbuilder.NewStruct(new(entitiesv2.KeyPair)).
		For(d.Flavor)
...
func (d *CommonDatabase) GetCurrentSigningKey(tx *sql.Tx) (*entitiesv2.KeyPair, error) {
	keyPairStruct := sqlbuilder.NewStruct(new(entitiesv2.KeyPair)).
		For(d.Flavor)
