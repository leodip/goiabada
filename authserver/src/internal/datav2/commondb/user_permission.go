...
func (d *CommonDatabase) GetUserPermissionById(tx *sql.Tx, userPermissionId int64) (*entitiesv2.UserPermission, error) {
...
func (d *CommonDatabase) GetUserPermissionsByUserIds(tx *sql.Tx, userIds []int64) ([]entitiesv2.UserPermission, error) {
...
func (d *CommonDatabase) GetUserPermissionsByUserId(tx *sql.Tx, userId int64) ([]entitiesv2.UserPermission, error) {
...
func (d *CommonDatabase) GetUserPermissionByUserIdAndPermissionId(tx *sql.Tx, userId, permissionId int64) (*entitiesv2.UserPermission, error) {
