...
func (d *CommonDatabase) GetCodeById(tx *sql.Tx, codeId int64) (*entitiesv2.Code, error) {
...
func (d *CommonDatabase) CodeLoadClient(tx *sql.Tx, code *entitiesv2.Code) error {
...
func (d *CommonDatabase) CodeLoadUser(tx *sql.Tx, code *entitiesv2.Code) error {
...
func (d *CommonDatabase) GetCodeByCodeHash(tx *sql.Tx, codeHash string, used bool) (*entitiesv2.Code, error) {
	codeStruct := sqlbuilder.NewStruct(new(entitiesv2.Code)).
		For(d.Flavor)
