...
func (d *CommonDatabase) CreateClient(tx *sql.Tx, client *entitiesv2.Client) error {
...
func (d *CommonDatabase) GetClientById(tx *sql.Tx, clientId int64) (*entitiesv2.Client, error) {
...
func (d *CommonDatabase) GetClientByClientIdentifier(tx *sql.Tx, clientIdentifier string) (*entitiesv2.Client, error) {
...
func (d *CommonDatabase) ClientLoadRedirectURIs(tx *sql.Tx, client *entitiesv2.Client) error {
...
func (d *CommonDatabase) ClientLoadWebOrigins(tx *sql.Tx, client *entitiesv2.Client) error {
...
func (d *CommonDatabase) GetClientsByIds(tx *sql.Tx, clientIds []int64) ([]entitiesv2.Client, error) {
...
func (d *CommonDatabase) ClientLoadPermissions(tx *sql.Tx, client *entitiesv2.Client) error {
...
func (d *CommonDatabase) GetAllClients(tx *sql.Tx) ([]*entitiesv2.Client, error) {
