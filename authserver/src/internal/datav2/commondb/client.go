...
func SetClientInsertColsAndValues(insertBuilder *sqlbuilder.InsertBuilder, client *entitiesv2.Client) *sqlbuilder.InsertBuilder {
...
func ScanClient(rows *sql.Rows) (*entitiesv2.Client, error) {
	var (
		id                                             int64
