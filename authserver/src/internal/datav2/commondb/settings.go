...
func (d *CommonDatabase) CreateSettings(tx *sql.Tx, settings *entitiesv2.Settings) error {
...
func (d *CommonDatabase) GetSettingsById(tx *sql.Tx, settingsId int64) (*entitiesv2.Settings, error) {
