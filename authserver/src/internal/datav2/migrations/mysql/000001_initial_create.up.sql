...
CREATE TABLE `resources` (
  ...
  `created_at` datetime(3) DEFAULT NULL,
  `updated_at` datetime(3) DEFAULT NULL,
  `resource_identifier` varchar(32) NOT NULL,
  `description` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `groups` (
  ...
  `created_at` datetime(3) DEFAULT NULL,
  `updated_at` datetime(3) DEFAULT NULL,
  `group_identifier` varchar(32) NOT NULL,
  `description` varchar(128) DEFAULT NULL,
...
CREATE TABLE `settings` (
  ...
  `password_policy` bigint DEFAULT NULL,
  `self_registration_enabled` tinyint(1) NOT NULL,
  `self_registration_requires_email_verification` tinyint(1) NOT NULL,
  `token_expiration_in_seconds` bigint NOT NULL,
  `refresh_token_offline_idle_timeout_in_seconds` bigint NOT NULL,
  `refresh_token_offline_max_lifetime_in_seconds` bigint NOT NULL,
  `user_session_idle_timeout_in_seconds` bigint NOT NULL,
  `user_session_max_lifetime_in_seconds` bigint NOT NULL,
