...
func NewSQLStore(db datav2.Database, path string, maxAge int, httpOnly bool,
...
func (store *SQLStore) load(session *sessions.Session) error {
	...
	var sess *entitiesv2.HttpSession
