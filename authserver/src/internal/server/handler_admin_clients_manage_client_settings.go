...
func (s *Server) handleAdminClientManageClientSettingsGet() http.HandlerFunc {
...
func (s *Server) handleAdminClientManageClientSettingsPost(identifierValidator identifierValidator) http.HandlerFunc {
