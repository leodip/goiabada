...
func (s *Server) handleAuthOtpPost() http.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		incorrectOtpError := customerrors.NewAppError(nil, "", "Incorrect OTP Code. OTP codes are time-sensitive and change every 30 seconds. Make sure you're using the most recent code generated by your authenticator app.", http.StatusOK)
