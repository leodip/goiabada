...
ALTER TABLE users ADD COLUMN forgot_password_code_hash character varying(64) NOT NULL DEFAULT '';
ALTER TABLE pre_registrations ADD COLUMN verification_code_hash character varying(64) NOT NULL DEFAULT '';
