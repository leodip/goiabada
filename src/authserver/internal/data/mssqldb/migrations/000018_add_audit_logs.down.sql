...
WHERE (dc.parent_object_id = OBJECT_ID(N'settings') AND c.name IN (N'audit_logs_in_console_enabled', N'audit_logs_in_database_enabled', N'audit_log_retention_days'));
