...
--
-- This is a data-only migration (SQL Server). Statements are DISJOINT and
...
UPDATE users SET
  phone_number = N'18' + phone_number,
...
WHERE phone_number_country_uniqueid = 'ALA_0'
  ...
  AND (DATALENGTH(phone_number) / 2) <= 28;
UPDATE users SET
  phone_number_country_uniqueid = 'ALA_0',
  phone_number_country_callingcode = '+358',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'ALA_0'
  AND phone_number_country_callingcode = '+35818'
  AND (phone_number IS NULL OR phone_number = '' OR (DATALENGTH(phone_number) / 2) > 28);

UPDATE users SET
  phone_number = N'3' + phone_number,
...
WHERE phone_number_country_uniqueid = 'BES_0'
  ...
  AND phone_number IS NOT NULL AND phone_number <> ''
  AND (DATALENGTH(phone_number) / 2) <= 29;
UPDATE users SET
  phone_number_country_uniqueid = 'BES_0',
  phone_number_country_callingcode = '+599',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'BES_0'
  AND phone_number_country_callingcode = '+5993'
  AND (phone_number IS NULL OR phone_number = '' OR (DATALENGTH(phone_number) / 2) > 29);

UPDATE users SET
  phone_number = N'4' + phone_number,
  phone_number_country_uniqueid = 'BES_0',
  phone_number_country_callingcode = '+599'
...
UPDATE users SET
  phone_number = N'89162' + phone_number,
...
WHERE phone_number_country_uniqueid = 'CCK_1'
  ...
  AND phone_number IS NOT NULL AND phone_number <> ''
  AND (DATALENGTH(phone_number) / 2) <= 25;
UPDATE users SET
  phone_number_country_uniqueid = 'CCK_0',
  phone_number_country_callingcode = '+61',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'CCK_1'
  AND phone_number_country_callingcode = '+6189162'
  AND (phone_number IS NULL OR phone_number = '' OR (DATALENGTH(phone_number) / 2) > 25);

UPDATE users SET
  phone_number = N'9' + phone_number,
...
UPDATE users SET
  phone_number = N'89164' + phone_number,
...
UPDATE users SET
  phone_number = N'1481' + phone_number,
...
WHERE phone_number_country_uniqueid = 'GGY_0'
  ...
  AND phone_number IS NOT NULL AND phone_number <> ''
  AND (DATALENGTH(phone_number) / 2) <= 26;
UPDATE users SET
  phone_number_country_uniqueid = 'GGY_0',
  phone_number_country_callingcode = '+44',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'GGY_0'
  AND phone_number_country_callingcode = '+441481'
  AND (phone_number IS NULL OR phone_number = '' OR (DATALENGTH(phone_number) / 2) > 26);

UPDATE users SET
  phone_number = N'1624' + phone_number,
...
UPDATE users SET
  phone_number = N'1534' + phone_number,
...
UPDATE users SET
  phone_number = N'787' + phone_number,
...
WHERE phone_number_country_uniqueid = 'PRI_0'
  ...
  AND phone_number IS NOT NULL AND phone_number <> ''
  AND (DATALENGTH(phone_number) / 2) <= 27;
UPDATE users SET
  phone_number_country_uniqueid = 'PRI_0',
  phone_number_country_callingcode = '+1',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'PRI_0'
  AND phone_number_country_callingcode = '+1787'
  AND (phone_number IS NULL OR phone_number = '' OR (DATALENGTH(phone_number) / 2) > 27);

UPDATE users SET
  phone_number = N'939' + phone_number,
  phone_number_country_uniqueid = 'PRI_0',
  phone_number_country_callingcode = '+1'
...
UPDATE users SET
  phone_number = N'79' + phone_number,
...
UPDATE users SET
  phone_number = N'698' + phone_number,
...
UPDATE users SET
  phone_number = N'269' + phone_number,
...
UPDATE users SET
  phone_number = N'639' + phone_number,
  phone_number_country_uniqueid = 'MYT_0',
  phone_number_country_callingcode = '+262'
