...
ADD include_open_id_connect_claims_in_id_token BIT NOT NULL DEFAULT 1;

-- Per-client override for OIDC claims in ID tokens
-- 'default' = use global setting, 'on' = enabled, 'off' = disabled
ALTER TABLE clients
ADD include_open_id_connect_claims_in_id_token VARCHAR(10) NOT NULL DEFAULT 'default';
