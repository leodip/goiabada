...
//
// A per-package copy, the sixth: handlers, apihandlers, usercreation, usersession and revocation
// each carry their own, and sharing them is a change of its own rather than a rider on #387. This
// one is copied from revocation verbatim.
//
