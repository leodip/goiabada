...
func TestHandleAPIAccountProfilePicturePost_CreateNew(t *testing.T) {
	...
	auditLogger.On("Log", mock.Anything, constants.AuditUpdatedOwnProfilePicture, mock.MatchedBy(func(details map[string]interface{}) bool {
...
func TestHandleAPIAccountProfilePictureDelete_Success(t *testing.T) {
	...
	auditLogger.On("Log", mock.Anything, constants.AuditDeletedOwnProfilePicture, mock.MatchedBy(func(details map[string]interface{}) bool {
		return details["userId"] == user.Id
	})).Return()
