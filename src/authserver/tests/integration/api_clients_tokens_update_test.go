...
func TestAPIClientTokensPut_Success(t *testing.T) {
	...
	assert.Equal(t, req.IncludeOpenIDConnectClaimsInIdToken, refreshed.IncludeOpenIDConnectClaimsInIdToken)
}
...
func TestAPIClientTokensPut_ValidationErrors(t *testing.T) {
	...
	cases := []struct {
		...
		{"token_exp_too_large", api.UpdateClientTokensRequest{TokenExpirationInSeconds: tooLarge, RefreshTokenOfflineIdleTimeoutInSeconds: 1, RefreshTokenOfflineMaxLifetimeInSeconds: 2, IncludeOpenIDConnectClaimsInAccessToken: "default", IncludeOpenIDConnectClaimsInIdToken: "default"}, "Token expiration in seconds must be between 0 and"},
		{"idle_too_large", api.UpdateClientTokensRequest{TokenExpirationInSeconds: 1, RefreshTokenOfflineIdleTimeoutInSeconds: tooLarge, RefreshTokenOfflineMaxLifetimeInSeconds: tooLarge, IncludeOpenIDConnectClaimsInAccessToken: "default", IncludeOpenIDConnectClaimsInIdToken: "default"}, "idle timeout in seconds must be between 0 and"},
		{"maxlife_too_large", api.UpdateClientTokensRequest{TokenExpirationInSeconds: 1, RefreshTokenOfflineIdleTimeoutInSeconds: 1, RefreshTokenOfflineMaxLifetimeInSeconds: tooLarge, IncludeOpenIDConnectClaimsInAccessToken: "default", IncludeOpenIDConnectClaimsInIdToken: "default"}, "max lifetime in seconds must be between 0 and"},
		{"idle_gt_maxlife", api.UpdateClientTokensRequest{TokenExpirationInSeconds: 1, RefreshTokenOfflineIdleTimeoutInSeconds: 5, RefreshTokenOfflineMaxLifetimeInSeconds: 4, IncludeOpenIDConnectClaimsInAccessToken: "default", IncludeOpenIDConnectClaimsInIdToken: "default"}, "idle timeout cannot be greater than max lifetime"},
		{"invalid_three_state_access", api.UpdateClientTokensRequest{TokenExpirationInSeconds: 1, RefreshTokenOfflineIdleTimeoutInSeconds: 1, RefreshTokenOfflineMaxLifetimeInSeconds: 2, IncludeOpenIDConnectClaimsInAccessToken: "invalid", IncludeOpenIDConnectClaimsInIdToken: "default"}, "Invalid value for includeOpenIDConnectClaimsInAccessToken"},
		{"invalid_three_state_id", api.UpdateClientTokensRequest{TokenExpirationInSeconds: 1, RefreshTokenOfflineIdleTimeoutInSeconds: 1, RefreshTokenOfflineMaxLifetimeInSeconds: 2, IncludeOpenIDConnectClaimsInAccessToken: "default", IncludeOpenIDConnectClaimsInIdToken: "invalid"}, "Invalid value for includeOpenIDConnectClaimsInIdToken"},
		{"negatives_rejected", api.UpdateClientTokensRequest{TokenExpirationInSeconds: -1, RefreshTokenOfflineIdleTimeoutInSeconds: -1, RefreshTokenOfflineMaxLifetimeInSeconds: -1, IncludeOpenIDConnectClaimsInAccessToken: "default", IncludeOpenIDConnectClaimsInIdToken: "default"}, "must be between 0 and"},
	}
