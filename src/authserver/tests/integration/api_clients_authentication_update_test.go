...
// helper to create a confidential client directly in DB
func createConfidentialClient(t *testing.T) (*models.Client, string) {
    t.Helper()
...
func TestAPIClientAuthenticationPut_ConfidentialToPublic_Success(t *testing.T) {
    ...
    client, _ := createConfidentialClient(t)
