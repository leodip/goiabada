...
WHERE (t.name = N'clients' AND c.name IN (N'include_open_id_connect_claims_in_id_token'))
   OR (t.name = N'settings' AND c.name IN (N'include_open_id_connect_claims_in_id_token'));
