...
--
-- This is a data-only migration (MySQL). Statements are DISJOINT and
...
UPDATE users SET
  phone_number = CONCAT('18', phone_number),
...
WHERE phone_number_country_uniqueid = 'ALA_0'
  ...
  AND CHAR_LENGTH(phone_number) <= 28;
UPDATE users SET
  phone_number_country_uniqueid = 'ALA_0',
  phone_number_country_callingcode = '+358',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'ALA_0'
  AND phone_number_country_callingcode = '+35818'
  AND (phone_number IS NULL OR phone_number = '' OR CHAR_LENGTH(phone_number) > 28);

UPDATE users SET
  phone_number = CONCAT('3', phone_number),
...
WHERE phone_number_country_uniqueid = 'BES_0'
  ...
  AND phone_number IS NOT NULL AND phone_number <> ''
  AND CHAR_LENGTH(phone_number) <= 29;
UPDATE users SET
  phone_number_country_uniqueid = 'BES_0',
  phone_number_country_callingcode = '+599',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'BES_0'
  AND phone_number_country_callingcode = '+5993'
  AND (phone_number IS NULL OR phone_number = '' OR CHAR_LENGTH(phone_number) > 29);

UPDATE users SET
  phone_number = CONCAT('4', phone_number),
  phone_number_country_uniqueid = 'BES_0',
  phone_number_country_callingcode = '+599'
...
UPDATE users SET
  phone_number = CONCAT('89162', phone_number),
...
WHERE phone_number_country_uniqueid = 'CCK_1'
  ...
  AND phone_number IS NOT NULL AND phone_number <> ''
  AND CHAR_LENGTH(phone_number) <= 25;
UPDATE users SET
  phone_number_country_uniqueid = 'CCK_0',
  phone_number_country_callingcode = '+61',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'CCK_1'
  AND phone_number_country_callingcode = '+6189162'
  AND (phone_number IS NULL OR phone_number = '' OR CHAR_LENGTH(phone_number) > 25);

UPDATE users SET
  phone_number = CONCAT('9', phone_number),
...
UPDATE users SET
  phone_number = CONCAT('89164', phone_number),
...
UPDATE users SET
  phone_number = CONCAT('1481', phone_number),
...
WHERE phone_number_country_uniqueid = 'GGY_0'
  ...
  AND phone_number IS NOT NULL AND phone_number <> ''
  AND CHAR_LENGTH(phone_number) <= 26;
UPDATE users SET
  phone_number_country_uniqueid = 'GGY_0',
  phone_number_country_callingcode = '+44',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'GGY_0'
  AND phone_number_country_callingcode = '+441481'
  AND (phone_number IS NULL OR phone_number = '' OR CHAR_LENGTH(phone_number) > 26);

UPDATE users SET
  phone_number = CONCAT('1624', phone_number),
...
UPDATE users SET
  phone_number = CONCAT('1534', phone_number),
...
UPDATE users SET
  phone_number = CONCAT('787', phone_number),
...
WHERE phone_number_country_uniqueid = 'PRI_0'
  ...
  AND phone_number IS NOT NULL AND phone_number <> ''
  AND CHAR_LENGTH(phone_number) <= 27;
UPDATE users SET
  phone_number_country_uniqueid = 'PRI_0',
  phone_number_country_callingcode = '+1',
  phone_number_verified = 0,
...
WHERE phone_number_country_uniqueid = 'PRI_0'
  AND phone_number_country_callingcode = '+1787'
  AND (phone_number IS NULL OR phone_number = '' OR CHAR_LENGTH(phone_number) > 27);

UPDATE users SET
  phone_number = CONCAT('939', phone_number),
  phone_number_country_uniqueid = 'PRI_0',
  phone_number_country_callingcode = '+1'
...
UPDATE users SET
  phone_number = CONCAT('79', phone_number),
...
UPDATE users SET
  phone_number = CONCAT('698', phone_number),
...
UPDATE users SET
  phone_number = CONCAT('269', phone_number),
...
UPDATE users SET
  phone_number = CONCAT('639', phone_number),
  phone_number_country_uniqueid = 'MYT_0',
  phone_number_country_callingcode = '+262'
