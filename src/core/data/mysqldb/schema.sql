...
-- Tables without foreign key dependencies (base tables)
...
CREATE TABLE `clients` (
  ...
  `show_display_name` TINYINT(1) NOT NULL DEFAULT 0,
  `show_description` TINYINT(1) NOT NULL DEFAULT 0,
  `show_website_url` TINYINT(1) NOT NULL DEFAULT 0,
