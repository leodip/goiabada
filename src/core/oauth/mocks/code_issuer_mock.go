...
// CreateAuthCode provides a mock function with given fields: input
func (_m *CodeIssuer) CreateAuthCode(input *oauth.CreateCodeInput) (*models.Code, error) {
	ret := _m.Called(input)
	...
	var r0 *models.Code
	var r1 error
	if rf, ok := ret.Get(0).(func(*oauth.CreateCodeInput) (*models.Code, error)); ok {
		return rf(input)
	}
	if rf, ok := ret.Get(0).(func(*oauth.CreateCodeInput) *models.Code); ok {
		r0 = rf(input)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*oauth.CreateCodeInput) error); ok {
		r1 = rf(input)
	} else {
		r1 = ret.Error(1)
	}
