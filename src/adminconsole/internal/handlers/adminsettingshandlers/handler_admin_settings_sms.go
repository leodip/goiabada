...
func HandleAdminSettingsSMSPost(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		auditLogger.Log(constants.AuditUpdatedSMSSettings, map[string]interface{}{
		...
		http.Redirect(w, r, fmt.Sprintf("%v/admin/settings/sms", config.Get().BaseURL), http.StatusFound)
	}
}
