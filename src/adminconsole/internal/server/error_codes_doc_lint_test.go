...
// TestErrorCodeDocMatchesTheCatalog fails the admin console unit tier when
...
// user-visible error message is worth a guard. core and the auth server call it from their own
// tiers.
