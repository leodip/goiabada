...
func (c *AuthServerClient) GetSettingsGeneral(ctx context.Context, accessToken string) (*api.SettingsGeneralResponse, error) {
	return execute[api.SettingsGeneralResponse](ctx, c, accessToken, apiRequest{
		method:        "GET",
		url:           c.baseURL + "/api/v1/admin/settings/general",
...
func (c *AuthServerClient) UpdateSettingsGeneral(ctx context.Context, accessToken string, request *api.UpdateSettingsGeneralRequest) (*api.SettingsGeneralResponse, error) {
	return execute[api.SettingsGeneralResponse](ctx, c, accessToken, apiRequest{
		method:        "PUT",
		url:           c.baseURL + "/api/v1/admin/settings/general",
		jsonBody:      request,
